...
data=[];
for i=1:10
invoke(pxi.Acquisition, 'initiateacquisition')
[waveformArray, waveformInfo] = invoke(pxi.Acquisition, 'fetch', channelList,TimeOut, numSamples, waveformArray, waveformInfo); %%
